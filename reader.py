...
class tx_frame(Structure):
    ...
    _fields_ = [("Header", c_uint8),
                ...
                ("UUID", c_uint8 * 3),
                ("TAG", c_uint8 * 3),
                ("RPM_setting", c_uint16),
                ("RPM_measure", c_uint16),
                ("PEAK_pressure_setting", c_uint16),
                ("PEAK_pressure_measure", c_uint16),
                ("PEEP_pressure_setting", c_uint16),
                ("PEEP_pressure_measure", c_uint16),
                ("TriggerFlow_setting", c_uint16),
                ("Flow_measure", c_uint16),
                ("Ramp_setting", c_uint16),
                ("ActiveAlarmCode", c_uint8),
                ("StatusBitField", c_uint8),
                ("TempValueEnc1", c_uint8),
                ("TempValueEnc2", c_uint8),
...
def check_crc(packet):
    ...
    packet.Crc = 0
    calculated_crc = crc16(struct_to_bytes(packet))
